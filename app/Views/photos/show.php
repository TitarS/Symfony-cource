                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="content">
                            ...
                            <a href="/photos/<?= $photo['id'];?>/download" class="button  is-primary is-outlined is-pulled-right">Скачать</a>
        ...
        <?php foreach($userImages as $image):?>
            <div class="column is-one-quarter">
                <div class="card">
                    ...
                    <div class="card-content" style="padding-left: 1em; padding-right: 1em">
                        <div class="media">
                            <div class="media-left">
